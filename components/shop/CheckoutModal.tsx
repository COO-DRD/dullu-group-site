...
function TipButton({ icon, label, copiedLabel, onClick, border, color }: {
  ...
  return (
    <button
      ...
      className="btn-press flex-1 flex items-center justify-center gap-2 py-2.5 font-sans text-[11px] font-light cursor-pointer"
      style={{
...
export default function CheckoutModal({
  ...
  // Entrance animation — mount with opacity 0, then transition to 1
  ...
  return (
    ...
    >
      ...
      >
        <button
          onClick={onClose}
          className="btn-press absolute top-4 right-5 text-2xl leading-none cursor-pointer"
          style={{ color: "#AAAAAA", background: "none", border: "none", transition: "color 140ms ease, transform 140ms cubic-bezier(0.23,1,0.32,1)" }}
          aria-label="Close"
        >
          ×
        </button>
        ...
        {/* Step content — key causes re-mount, .step-enter fades in each state */}
        <div key={step} className="step-enter">
          ...
          {step === "form" && (
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <button
                type="submit"
                className="btn-press w-full font-sans font-bold text-[11px] tracking-[0.15em] uppercase py-4 cursor-pointer mt-2"
                style={{ backgroundColor: "#D4580A", color: "#FFFFFF", transition: "transform 140ms cubic-bezier(0.23,1,0.32,1), filter 140ms ease" }}
              >
              ...
              <div className="text-center">
                ...
                {downloadUrl && (
                  <a
                    ...
                    className="btn-press block w-full font-sans font-bold text-[11px] tracking-[0.15em] uppercase py-4"
                    style={{ backgroundColor: "#D4580A", color: "#FFFFFF", transition: "transform 140ms cubic-bezier(0.23,1,0.32,1), filter 140ms ease" }}
                  >
                    Download Now <Arr />
                  </a>
                ...
                <div className="mt-8 pt-6 border-t" style={{ borderColor: "#F0EDE8" }}>
                  ...
                  <div className="flex gap-3">
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="btn-press flex-1 flex items-center justify-center gap-2 py-2.5 font-sans text-[11px] font-light"
                      style={{ border: "1px solid #DDDDDD", color: "#888888", transition: "background-color 140ms ease-out, transform 140ms cubic-bezier(0.23,1,0.32,1)" }}
                    >
                      <PayPalIcon />
                      PayPal
                    </a>
          ...
          {step === "error" && (
            <div className="py-4">
              ...
              <button
                ...
                className="btn-press w-full font-sans font-semibold text-[11px] tracking-[0.15em] uppercase py-3 border cursor-pointer"
                style={{ borderColor: "#D4580A", color: "#D4580A", transition: "transform 140ms cubic-bezier(0.23,1,0.32,1), filter 140ms ease" }}
              >
                Try Again
              </button>
            </div>
