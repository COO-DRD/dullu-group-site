      ...
      <div className="max-w-6xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-start">
          <div>
            ...
            <h2 className="font-display text-4xl md:text-5xl font-bold text-bean leading-tight">
              One person. Every system documented.
            </h2>
          </div>

          <div>
            <p className="text-bean-muted leading-relaxed mb-6">
            ...
            <p className="text-bean-muted leading-relaxed mb-10">
            ...
            <div className="flex flex-wrap gap-6">
              {socials.map((s) => (
                <a
                  ...
                  className="text-sm text-cognac border-b border-cognac/30 pb-0.5 hover:border-cognac transition-colors"
                >
                  {s.label} ↗
                </a>
              ))}
